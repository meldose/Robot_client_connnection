...
# -------------------------------------------------------------------
    def pho_request_init(self, vs_id, start, end): # definition of pho_request_init
    ...
    def pho_request_bsp_get_vision_system_status(self, vs_id): # definition of pho_request_bsp_get_vision_system_status
        payload = [vs_id, 0, 0, 0]  # payload - vision system id
    ...
    def pho_receive_response(self, required_id=None, response=None):
        ...
        for message_count in range(header.number_of_messages):
            ...
            if operation_type == OperationType.PHO_TRAJECTORY_CNT or operation_type == OperationType.PHO_TRAJECTORY_FINE: # checking if the operation type is PHO_TRAJECTORY_CNT or PHO_TRAJECTORY_FINE
                ...
                data = self.client.recv(OBJECT_POSE_SIZE) # recieving the object pose size
